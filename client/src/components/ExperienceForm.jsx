...
const ExperienceForm = ({ data, onChange }) => {
  ...
  const generateDescription = async (index) => { // Fixed typo
            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="px-3 py-2 text-sm border border-gray-300 rounded-lg disabled:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-400"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm px-3 py-2 border border-gray-300 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-purple-400"
