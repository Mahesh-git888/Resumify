...
// 1. FIXED: Added 'Globe' to the import list
...
const PersonalInfoForm = ({ data, onChange, removeBackground, setRemoveBackground }) => {
  ...
  const fields = [
    ...
    { key: "phone", label: "Phone Number", icon: Phone, type: "tel" }, // Changed type to "tel" for better semantics
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        {/* This conditional check is correct. */}
        {/* The toggle will only appear if 'data.image' exists. */}
        {data.image && (
        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            <input
              ...
              // 2. FIXED: Corrected 'focus:border-blue' and removed extra space
              ...
              // 3. FIXED: Added space in placeholder
