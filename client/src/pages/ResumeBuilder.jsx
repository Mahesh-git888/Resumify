...
import ProfessionalSummaryForm from '../components/home/ProfessionalSummaryForm';
...
const ResumeBuilder = () => {
  ...
  const sections = [
    ...
    { id: 'projects', name: 'Projects', icon: FolderArchiveIcon },
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="relative bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              {/* Progress Bar */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gray-200 z-10"></div>
              <div
                className="absolute top-0 left-0 h-1 bg-gradient-to-r from-green-500 to-green-600 transition-all duration-700 z-20"
                style={{
